...
@section('content')
    <div class="card">
        <div class="card-body">
            ...
            <div class="p-2">
                <form class="row g-3" action="{{ route('dashboard.prestasi.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')

                    <div class="col-md-12">
                        <label for="inputPrestasiName" class="form-label"><strong>Judul Prestasi</strong></label>
                        <input type="text" class="form-control" id="inputPrestasiName" value="{{ old('title') }}"
                            name="title" required>
                    </div>
                    ...
                    <div class="col-md-12">
                        <label for="inputImagePrestasi" class="form-label"><strong>Dokumentasi kegiatan</strong></label>
                        <input type="file" class="form-control" id="inputImagePrestasi" value="{{ old('image') }}"
                            name="image" required>
                    </div>

                    <div class="col-md-12">
                        <label class="form-label"><strong>Isi Kegiatan</strong></label>
